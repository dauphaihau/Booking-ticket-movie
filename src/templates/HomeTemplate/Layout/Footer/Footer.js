...
function Footer(props) {
    ...
    const arrCinemaSystem = _.map(arrCinema, (arrCinema) => _.pick(arrCinema, ['maHeThongRap', 'tenHeThongRap']))

    console.log('arr-cinema', arrCinemaSystem)

    return (
        // <footer className="py-6 text-white bg-gray-100 " style={{backgroundColor: '#222222'}} >
        ...
        //                             <img src={cinema.logo} alt={cinema.tenHeThongRap} width={50}/>
        //                         </div>
        //                     })}
        //                 </div>
        //             </div>
        ...
        <div className="px-12 pt-16 mx-auto sm:max-w-45rem md:max-w-full lg:max-w-screen-xl md:px-16 lg:px-10">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
              ...
              Moviee
                ...
                {/*<div>*/}
                {/*    <div className="col-span-6 text-center md:text-left md:col-span-3">*/}
                {/*        <p className="text-base font-bold tracking-wide text-gray-900">ĐỐI TÁC</p>*/}
