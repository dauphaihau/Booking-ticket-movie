...
function CheckoutCard({infoMovie, listBookingSeats, props}) {
    ...
    return (
        <div className='flex max-w-sm w-full bg-white shadow-md rounded-lg overflow-hidden'>
            <div className="overflow-hidden w-full rounded-xl hover:rounded-xl relative transform hover:-translate-y-2 transition ease-in-out duration-500 shadow-lg hover:shadow-2xl movie-item text-white movie-card" data-movie-id="438631">
                ...
                <div className="relative cursor-pointer group z-10
                    px-10
                    {/*pl-10 pr-14*/}
                     pt-10 space-y-6 movie_info" data-lity="" href="https://www.youtube.com/embed/aSHs224Dge0">
                    <div className="poster__info align-self-end w-full">
                        <div className="h-32"/>
                        <div className="space-y-6 detail_info">
                            <div className="flex flex-col space-y-2 inner">
                                <a href={infoMovie.trailer} className="rounded-full relative flex items-center w-min flex-shrink-0 p-1 text-center text-white
                                ...
                                <h3 className="text-2xl font-bold text-white" data-unsp-sanitized="clean">{infoMovie.tenPhim}</h3>
