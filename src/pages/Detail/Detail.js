        ...
        <div style={{
            ...
            >
                ...
                <div className='my-20 mx-auto container bg-white px-0 py-5 rounded-lg'>
                    <Tabs defaultActiveKey='1' centered className='hidden lg:block'>
                    ...
                    {/*                            {cinema.cumRapChieu.slice(0, 5).map((cumRap, index) => {*/}
                    {/*                                return <div className='mt-5' key={index}>*/}
                    {/*                                    <div className='flex flex-row mt-2 h-20'>*/}
                    {/*                                        <img width={70} height={70} src={cumRap.hinhAnh}*/}
                    {/*                                             alt={cumRap.tenCumRap}/>*/}
                    {/*                                        <div className='ml-4'>*/}
                    {/*                                            <p className='text-[10px] font-bold leading-3'>{cumRap.tenCumRap}</p>*/}
                    {/*                                            <p className='text-[10px] mb-4'>{cumRap.diaChi.length > 34 ?*/}
                    {/*                                                <span>{cumRap.diaChi.slice(0, 34)}..</span> :*/}
